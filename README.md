...
**Version 1.0.2** — the first release candidate. It has not yet been submitted to Plugin Hub; the live acceptance sweep is deferred to the first players' reports.
